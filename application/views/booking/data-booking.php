                        ...
                        <table class="table table-bordered table-striped table-hover" id="table-datatable">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td nowrap><?= $t['panitia']; ?></td>
                                    <td nowrap><?= substr(
                                                    $t['jadwal_keberangkatan'],
                                                    0,
                                                    4
                                                ); ?></td>
                                    <td nowrap>
                                        <a href="<?= base_url('booking/hapusbooking/' . $t['id_tiket']); ?>" onclick="return_konfirm('Yakin tidak Jadi Booking '.$t['armada'])"><i class="btn btn-sm btn-outline-danger fas fw fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php $no++;
                            } ?>
