...
class ModelPinjam extends CI_Model
{
    ...
    {
        $sql = "INSERT INTO detail_pinjam (no_pinjam,id_tiket) SELECT pinjam.no_pinjam,booking_detail.id_tiket FROM pinjam, booking_detail WHERE booking_detail.id_booking=$idbooking AND pinjam.no_pinjam='$nopinjam'";
        $this->db->query($sql);
    }
}
