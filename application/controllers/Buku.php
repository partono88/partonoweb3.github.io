...
class Tiket extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['tiket'] = $this->ModelTiket->getBuku()->result_array();
    ...
    public function ubahTiket()
    {
        ...
        $data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
        $data['tiket'] = $this->ModelTiket->bukuWhere(['id' => $this->uri->segment(3)])->result_array();
        $kategori = $this->ModelTiket->joinKategoriBuku(['buku.id' => $this->uri->segment(3)])->result_array();
